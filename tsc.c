...
int dummy(BASETYPE[LEN], BASETYPE[LEN], BASETYPE[LEN], BASETYPE[LEN], BASETYPE[LEN], BASETYPE[LEN2][LEN2], BASETYPE[LEN2][LEN2], BASETYPE[LEN2][LEN2], BASETYPE);
...
inline BASETYPE f(BASETYPE a, BASETYPE b){
	return a*b;
}
...
//	expression in loop bounds and subscripts
	...
	clock_t start_t, end_t, clock_dif; double clock_dif_sec;
	shortdesc = "symbolics: expression in loop bounds and subscripts";
...
//	loop with subscript that may seem ambiguous
	...
	clock_t start_t, end_t, clock_dif; double clock_dif_sec;
	shortdesc = "symbolics: loop with ambiguous subscript";
...
//	symbolic dependence tests
        ...
        clock_t start_t, end_t, clock_dif; double clock_dif_sec;
	shortdesc = "symbolics: symbolic dependence";
...
//	convolution
	...
	clock_t start_t, end_t, clock_dif; double clock_dif_sec;
	shortdesc = "symbolics: convolution";
...
void set(int* ip, BASETYPE* s1, BASETYPE* s2){
	...
	posix_memalign((void**)&xx, 16, LEN*sizeof(BASETYPE));
#else
...
#error 'unable to allocate aligned memory'
	...
	posix_memalign((void**)&ip, 16, LEN*sizeof(int));
#endif
